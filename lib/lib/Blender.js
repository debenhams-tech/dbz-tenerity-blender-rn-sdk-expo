...
// @ts-ignore
export const Blender = ({ bannerType, campaignId, webViewProps = {}, isBannerShown, showLoadingIndicator = false, isLoggingEnabled = false, inlineBannerStyle, keywords = null, }) => {
    ...
    useEffect(() => {
        const fetchBanners = async () => {
            try {
                ...
                const banners = await fetchWlBanners(campaignId, bannerLog, keywords);
